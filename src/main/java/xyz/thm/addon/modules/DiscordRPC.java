...
public class DiscordRPC extends Module {
    ...
    public DiscordRPC() {
        super(THMAddon.MAIN, "discord-RPC", "Displays Watchmen (Additions) as an activity on discord.");
    ...
    public void onActivate() {
        ...
        rpc.setStart(System.currentTimeMillis() / 1000L);
            ...
            String largeText = "THM Additions " + THMAddon.VERSION;
        rpc.setLargeImage("thm", largeText);
    ...
    private void onTick(TickEvent.Post event) {
        ...
        if (Utils.canUpdate()) {
            ...
            if (!lastWasInMainMenu) {
                rpc.setDetails("THM Addons " + THMAddon.VERSION);
